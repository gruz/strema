...
# Create and push tag
# Note: VERSION file will be generated by GitHub Action during release
echo ""
...
echo "3. Users can update via: curl -fsSL https://raw.githubusercontent.com/gruz/strema/master/install.sh | sudo bash -s $NEW_VERSION"
